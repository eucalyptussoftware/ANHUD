...
object PrefsJson {
    ...
    private fun serializeOverlayPrefs(context: Context): JSONArray {
        ...
        putBoolean("overlay_mirror_enabled", OverlayPrefs.mirrorEnabled(context))
        putFloat("overlay_mirror_scale", OverlayPrefs.mirrorScale(context))
        putFloat("overlay_mirror_offset_x", OverlayPrefs.mirrorOffsetX(context))
        putFloat("overlay_mirror_offset_y", OverlayPrefs.mirrorOffsetY(context))
